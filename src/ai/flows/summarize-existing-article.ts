// Summarize the content of an existing article from a given URL.
 ...
 *
 * - summarizeArticle - A function that takes a URL and returns a short summary of the article.
...
const summarizeArticlePrompt = ai.definePrompt({
  ...
  prompt: `Summarize the content of the article at the following URL in a concise manner:\n\nURL: {{{url}}}`,
});
