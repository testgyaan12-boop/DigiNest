...
const teamMembers = [
  {
    ...
    bio: "The visionary and lead architect of our projects. John has over 10 years of experience turning complex problems into elegant software solutions.",
  ...
  },
  {
    ...
    bio: "Mike ensures our applications are fast, scalable, and secure. He's a wizard with databases, server-side logic, and cloud infrastructure.",
  ...
  return (
    <div className="container py-12 md:py-24">
      ...
      <p className="max-w-2xl mx-auto mt-4 text-center text-muted-foreground md:text-xl">
        We are a small but mighty team of passionate developers and designers dedicated to building great products.
      </p>
